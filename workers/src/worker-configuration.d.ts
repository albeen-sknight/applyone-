/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/src/worker-configuration.d.ts --config wrangler.toml` (hash: ef8e4b47f21078fe64a2501094051b85)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "GEMINI_MODEL" | "GEMINI_API_KEY">> {}
}
