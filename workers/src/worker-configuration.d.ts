/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/src/worker-configuration.d.ts --config .\wrangler.toml` (hash: c0166c4667039b70ea4706582f436352)
// Runtime types generated with workerd@1.20260603.1 2026-06-07 nodejs_compat
interface __BaseEnv_Env {
	applyone_db: D1Database;
	AI_PROVIDER: "gemini";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "GEMINI_MODEL" | "GEMINI_API_KEY" | "OWNER_PASSWORD_HASH" | "SESSION_SECRET" | "ALLOWED_ORIGINS">> {}
}
